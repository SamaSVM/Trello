...
public class MemberWorkspaceRepository {
    ...
    private final String FIND_BY_IDS_STMT =
            "SELECT * FROM member_workspace WHERE (member_id=? AND workspace_id=?);";
    private final String FIND_BY_WORKSPACE_ID_STMT =
            "SELECT * FROM member_workspace WHERE workspace_id=?;";
